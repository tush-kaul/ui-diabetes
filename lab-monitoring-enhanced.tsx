								...
								<Line
									...
									dot={(props) => {
										const { cx, cy, payload, index } =
											props;
										const color =
											payload.diastolic <= 80
												? "#22c55e"
												: payload.diastolic <= 90
												? "#eab308"
												: "#ef4444";
										return (
											<circle
												key={`dot-diastolic-${index}`}
												cx={cx}
												cy={cy}
												r={4}
												fill={color}
							...
							<div className="border rounded-lg p-6 bg-white shadow-sm">
								<div className="flex justify-between items-center mb-4 border-b pb-4">
									...
									<div className="text-right text-sm">
										<p>
											...
											21/7/2024 12:05:00PM
										</p>
										<p>
											<strong>Received:</strong> 21/7/2024
											12:09:48PM
										</p>
										<p>
											<strong>Reported:</strong> 21/7/2024
											6:24:32PM
										</p>
									</div>
								</div>
									...
									<table className="w-full">
										...
										<tbody>
											<tr className="border-t">
												<td
													colSpan={4}
													className="p-3 font-semibold bg-gray-50">
								...
								<div className="text-sm">
									...
									<div className="border rounded p-3 bg-gray-50">
										...
										<p className="text-xs">
											Measurements in the same patient can
											show physiological & analytical
											variations. Three serial samples 1
											week apart are recommended for Total
							...
							<div className="space-y-4">
								<div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
									...
									<p className="text-gray-600 mb-4">
										Upload lab reports, ECG, X-rays, or
