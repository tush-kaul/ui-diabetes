            ...
            <Card className="mb-4 page-break-inside-avoid">
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="font-semibold">For Diabetes:</p>
                  ...
                  <div>
                    <p className="font-semibold">For Blood Pressure & Heart:</p>
                  ...
                  <div>
                    ...
                    <ol className="ml-4 space-y-1" start="7">
          ...
          <Card className="mb-4 page-break-inside-avoid">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div>
                  <p className="font-semibold">Specialist Referrals Required:</p>
                ...
                <div>
                  <p className="font-semibold">Lab Investigations for Next Visit:</p>
                  <ul className="ml-4 space-y-1">
            ...
            <Card className="mb-4 page-break-inside-avoid">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="font-semibold">Diet & Lifestyle:</p>
                    <ul className="ml-4 space-y-1 text-sm">
                  ...
                  <div>
                    <p className="font-semibold">Monitoring at Home:</p>
                    <ul className="ml-4 space-y-1 text-sm">
                  ...
                  <div>
                    <p className="font-semibold">When to Contact Doctor Immediately:</p>
                    <ul className="ml-4 space-y-1 text-sm">
