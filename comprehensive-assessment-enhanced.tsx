      ...
      <Tabs defaultValue="complications" className="w-full">
        ...
        <TabsContent value="mental-health">
          <div className="space-y-6">
                ...
                <div className="mb-4">
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={mentalHealthData}>
                      ...
                      <YAxis />
                      <Tooltip />
                      <Line type="monotone" dataKey="phq9" stroke="#8884d8" name="PHQ-9 Score" />
                      <Line type="monotone" dataKey="gad7" stroke="#82ca9d" name="GAD-7 Score" />
            ...
            <Card className="bg-white shadow-lg">
              <CardHeader>
                <CardTitle className="text-xl text-navy-600">Mental Health Assessment</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <Label htmlFor="phq9">PHQ-9 Score (0-27)</Label>
                    <Input id="phq9" type="number" min="0" max="27" placeholder="Enter PHQ-9 score" />
                  ...
                  <div>
                    ...
                    <Input id="gad7" type="number" min="0" max="21" placeholder="Enter GAD-7 score" />
                    <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div>
                    ...
                    <Input id="stress" type="number" min="1" max="10" placeholder="Enter stress level" />
